$(function () {
  ...
  $.getJSON('https://pearl-aardvark-1811.twil.io/capability-token?phone=12562578050')
    .then(async function (data) {
      ...
      device.on('incoming', function (conn) {
        ...
        boundAsync.setConnectedCallSid(conn.parameters.CallSid);
      });

      setClientNameUI(data.identity);
      boundAsync.setConnectionAddress(data.identity);
  ...
  async function log(message) {
    ...
    boundAsync.showMessage(message);
  }
